...
public class BakeryMasterController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {	
        loadProperties("jsp/bakery/properties/BakeryCommand");
    }
    ...
    private void loadProperties(String filePath) {
    	...
    	while(actionEnum.hasMoreElements()) {
    		...
    		try {
    			...
    			//화면전환 action인지 확인
    			if(className.equals("jsp.bakerymaster.model.BakeryFormChangeAction")){
    				BakeryFormChangeAction bf = (BakeryFormChangeAction)actionInstance;
